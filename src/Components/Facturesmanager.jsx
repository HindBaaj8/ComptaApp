...
const Facturesmanager = () => {
  ...
  const modifierArticle = (index, champ, valeur) => {
    ...
    if (champ === 'prixUnitaire' || champ === 'tauxTVA') {
      nouveauxArticles[index][champ] = parseFloat(valeur) || 0;
    } else if (champ === 'quantite') {
      nouveauxArticles[index][champ] = parseFloat(valeur) || 1;
    } else {
                        ...
                        <tr key={index}>
                          ...
                          <td style={{ padding: '5px' }}>
                            <input
                              ...
                              onChange={(e) => modifierArticle(index, 'quantite', e.target.value)}
                          ...
                          <td style={{ padding: '5px' }}>
                            <input
                              ...
                              onChange={(e) => modifierArticle(index, 'prixUnitaire', e.target.value)}
                          ...
                          <td style={{ padding: '5px' }}>
                            <input
                              ...
                              min="0"
                              max="100"
                              value={article.tauxTVA || 0}
                              onChange={(e) => modifierArticle(index, 'tauxTVA', e.target.value)}
                              style={{ width: '100%', padding: '8px', border: '1px solid var(--border)', borderRadius: '4px', textAlign: 'center' }}
                              required
                            />
                          </td>
